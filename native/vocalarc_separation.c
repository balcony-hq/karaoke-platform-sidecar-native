...
static void select_simd(void) {
    if (getenv("VOCALARC_SCALAR") == NULL && vocalarc_simd_available()) {
        g_dot = vocalarc_dot_avx2;
        g_axpy = vocalarc_axpy_avx2;
        g_scale_head = vocalarc_scale_head_avx2;
        g_matmul_row = vocalarc_matmul_row_avx2;
        g_rms_norm_row = vocalarc_rms_norm_row_avx2;
